...
| landed #75 | iOS/web roof + season use `@expo/ui/community/segmented-control`; Android Config roof stays Compose to avoid a nested Host | [config.md](config.md), [simulation.md](simulation.md) |
