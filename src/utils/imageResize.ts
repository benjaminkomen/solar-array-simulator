...
/**
 * Prepare image for serial number extraction at higher resolution.
 * Uses the full original image (no resize) compressed to JPEG so that
 * small text like serial numbers remains legible.
 */
export async function prepareForSerialExtraction(
  uri: string,
